		...
		public bool SetField(int AtInternalColumnIndex, string sValue) {
			...
			try {
				if (fieldarr!=null) {
					...
					else RReporting.ShowErr("Column is out of range of internal field array","checking column index before setting field","tableEntry.SetField("+AtInternalColumnIndex.ToString()+",...)");
				}
